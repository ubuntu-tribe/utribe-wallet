...
export default {
    ...
    methods: {
        ...
        changeMenuMode(mode) {
            ...
            if (mode === 'horizontal') {
                if (this.d_colorScheme === 'light') {
                    ...
                    appLogoLink.src = 'assets/layout/images/utribe-icon.png';
                    horizontalLogoLink.src = 'assets/layout/images/utribe-icon.png';
                }
                else {
        ...
        changeColorScheme(scheme) {
            ...
            if (scheme === 'light') {
                if (this.d_menuMode === 'horizontal') {
                    ...
                    horizontalLogoLink.src = 'assets/layout/images/logo-dark.png';
                }
                else {
                    if (this.logoColor === 'white') {
                        appLogoLink.src = 'assets/layout/images/logo-white.png';
                    }
                    else {
                        appLogoLink.src = 'assets/layout/images/logo-dark.png';
                    }
        ...
        changeLogo() {
            ...
            const logoUrl = `assets/layout/images/logo-${this.d_colorScheme === 'light' ? 'dark' : 'white'}.png`;

            if (appLogoLink) {
                appLogoLink.src = `assets/layout/images/logo-${this.d_colorScheme === 'light' ? this.logoColor : 'white'}.png`;
            }
